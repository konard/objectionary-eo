...
```text
to-java.xsl              90443  40.22%
classes.xsl              74860  33.29%
set-locators.xsl         15538  6.91%
set-original-names.xsl   10412  4.63%
attrs.xsl                8675   3.86%
data.xsl                 7840   3.49%
anonymous-to-nested.xsl  5834   2.59%
tests.xsl                5792   2.58%
package.xsl              5484   2.44%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-02-04 at 16:21,
on Linux with 4 CPUs.
The total is 224878 milliseconds.
...
[benchmark-gha]: https://github.com/objectionary/eo/actions/runs/21678790601
